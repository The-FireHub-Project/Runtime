...
/**
 * ### Represents an invalid encoding provided to an operation that requires a valid encoding
 * @since 1.0.0
 */
final class InvalidEncodingException extends InvalidArgumentException {
     ...
     * @since 1.0.0
     */
    protected const string DEFAULT_MESSAGE = 'The provided encoding is invalid.';
