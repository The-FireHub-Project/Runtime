...
/**
 * ### Represents an invalid pattern provided to an operation that requires a valid pattern
 * @since 1.0.0
 */
final class InvalidPatternException extends InvalidArgumentException {
     ...
     * @since 1.0.0
     */
    protected const string DEFAULT_MESSAGE = 'The provided pattern is invalid.';
